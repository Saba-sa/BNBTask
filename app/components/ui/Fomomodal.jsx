...
const ModelTemplate = ({ isOpen, closeModal }) => {
  ...
  return (
    <>
      {isOpen && (
        <div
          className="main-modal fixed w-full h-full inset-0 z-50 flex justify-center items-center"
          ...
          <div className="modal-container h-[400px] bg-gray-800 text-white w-11/12 md:max-w-5xl mx-auto rounded-lg shadow-lg overflow-x-hidden overflow-y-scroll">
            <div className="modal-content py-4 text-left px-2">
              ...
              <div className="flex justify-end pt-4 pr-4">
                <button className="bg-transparent hover:bg-blue-500 text-white font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" onClick={closeModal}>CLOSE</button>
              </div>
            </div>
          </div>
        </div>
